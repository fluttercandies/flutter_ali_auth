...
abstract class _$AlertUIConfigCWProxy {
  ...
  AlertUIConfig call({
    ...
    dynamic? alertTitleBarConfig,
    double? alertWindowHeight,
    double? alertWindowWidth,
    dynamic? changeButtonConfig,
    dynamic? checkBoxConfig,
    dynamic? loginButtonConfig,
    dynamic? logoConfig,
    dynamic? phoneNumberConfig,
    dynamic? privacyConfig,
    dynamic? sloganConfig,
  });
}
